...
\begin{enumerate}[label=(\alph*), left=0pt, labelsep=1em, itemsep=1em]
    ...
    1. $\hat{\mathbf y} = \mathbf y$ (impossible due to softmax), or
    ...
    gradient descent updates $\mathbf v_c$ by pulling it towards the true context vector $\mathbf U\mathbf y$ and repelling it from the predicted expectation $\mathbf U\hat{\mathbf y}$.
\end{enumerate}
